package tests._indent;/*
	Sang Nguyen
	Block Indentation
	2 Errors should be found at line 6 and line 13
*/
...
double perimeter; // Sum of the sides of the triangle
      ...
      area = Math.sqrt(s*(s - a)*(s - b) *(s - c));         // Equation to calculate area of a triangle
      DecimalFormat format1 = new DecimalFormat("#0.00");   // change the answers to two decimal places
